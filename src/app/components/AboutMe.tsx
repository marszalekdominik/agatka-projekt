...
export default function AboutMe() {
    ...
    return (
        <section className="flex flex-col items-center justify-center py-7 px-6">
                ...
                <p className="text-center leading-[1.7] mb-4">Dziś swoją wiedzę przekładam na praktykę, oferując <Link onClick={() => trackButtonClick('about-me-konsultacje-pielegnacyjne', 'Konsultacje pielęgnacyjne')} className="underline font-bold" href="/pielegnacje/spersonalizowany-plan-pielegnacyjny">indywidualne konsultacje pielęgnacyjne</Link>, które pomagają dobrać skuteczną, spersonalizowaną rutynę pielęgnacyjną, dostosowaną do Twoich potrzeb.</p>
        </section>
    )
}