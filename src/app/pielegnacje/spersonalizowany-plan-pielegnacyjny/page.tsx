    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center justify-center">
                ...
                <p className="mb-5 leading-[1.6] text-center px-5">Jeśli jesteś zainteresowany/a spersonalizowanym planem pielęgnacyjnym napisz do mnie na: <a className="font-bold font-family-montserrat" href="mailto:agatastankonsultacje@gmail.com">agatastankonsultacje@gmail.com</a></p>
